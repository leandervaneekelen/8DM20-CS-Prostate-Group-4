#!/usr/bin/env python
#
# Transformix transforms of images and pointsets
#
# The Transformix class has two methods called transform_image and
# transform_points that can do all of the above.
#
